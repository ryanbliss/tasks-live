...
function pointerEventToIPointerEvent(e: PointerEvent, hOffset: number, vOffset: number): IPointerEvent {
    return {
        altKey: e.altKey,
        ctrlKey: e.ctrlKey,
        shiftKey: e.shiftKey,
...
export class NonClickablePointerInputProvider extends InputProvider {
            ...
            if (invokePointerMove) {
                ...
                coalescedEvents.forEach((evt: PointerEvent) => {
                    this.pointerMoveEvent.emit({
                        ...pointerEventToIPointerEvent(evt, this.hOffset, this.vOffset),
                        isPointerDown,
                    });
                });
            }
    ...
    private onPointerEnter = (e: PointerEvent): void => {
        if (this.isActive) {
            if (this._activePointerId === undefined) {
                this.pointerEnterEvent.emit(pointerEventToIPointerEvent(e, this.hOffset, this.vOffset));
            }
    ...
    private onPointerLeave = (e: PointerEvent): void => {
        if (this.isActive) {
            if (this._activePointerId === undefined) {
                this.pointerLeaveEvent.emit(pointerEventToIPointerEvent(e, this.hOffset, this.vOffset));
            }
